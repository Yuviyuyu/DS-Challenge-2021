...
df_alcoh_new = df_cr[(df_cr['Year'].between(2008,2017))&(df_cr['Alcohol involvement'].isin(['Alcohol involved']))]

df_alcoh_grouped = df_alcoh_new.groupby(['Year','Month number'],as_index=False).sum()
df_alcoh_grouped=df_alcoh_grouped.replace({"Month number": {1: "Jan", 2: "Feb", 3: "Mar", 4: "Apr", 5: "May", 
                                            6: "Jun", 7: "Jul", 8: "Aug", 9: "Sep", 10: "Oct", 11: "Nov", 12: "Dec"}})

df_alcoh_new1=df_alcoh_grouped.rename(columns={"Year": "year","Month number": "month",'Number of offences':'Total Alcohol-related assault offences'})
print(df_alcoh_new1)

#~~~~~~~~Alochol-related offences test Dataset~~~2018-2021 Jul~~~~~

df_alcoh_test_new = df_cr_test[df_cr_test['Year'].between(2018,2021)&(df_cr_test['Alcohol involvement'].isin(['Alcohol involved']))]

df_alcoh_test_grouped = df_alcoh_test_new.groupby(['Year','Month number'],as_index=False).sum()
df_alcoh_test_grouped=df_alcoh_test_grouped.replace({"Month number": {1: "Jan", 2: "Feb", 3: "Mar", 4: "Apr", 5: "May", 
                                            6: "Jun", 7: "Jul", 8: "Aug", 9: "Sep", 10: "Oct", 11: "Nov", 12: "Dec"}})


df_alcoh_test_new1=df_alcoh_test_grouped.rename(columns={'Year':'year','Month number':'month','Number of offences':'Total Alcohol-related assault offences'})
...
df_data3=df_data2.merge(df_alcoh_new1,on=["month","year"])
